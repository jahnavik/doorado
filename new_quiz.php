...
<div id="info-area">
 ...
 <form action="save_quiz.php" method="post" style="position:relative; padding:20px;  ">
...
$a='Ans.  '.$ans;
?>
<div id="main" class="card" style="height:1%" >
...
<div class="overlay_modal" id="quiz_modal" >
 ...
 <h2>New Question</h2>
  ...
  <form action="add_question.php" method="post" style="position:absolute; left:15%; width:30% ; top:150px" >
   
    <fieldset id="inputs">
                <input id="question" name="question" type="text" class="form-control" placeholder="Problem" autofocus required>   
                <input id="solution" name="solution" type="text"  class="form-control" placeholder="Solution" required>
